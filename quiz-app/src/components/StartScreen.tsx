        ...
        <div className="bg-white-16 backdrop-blur-lg rounded-3xl p-8 border border-white-40">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mb-8">
            {Object.entries(majors).map(([key, major]) => (
              <div key={key} className={`bg-[image:var(--gradient-purple-50)] p-4 rounded-xl text-neutral-900 text-center`}>
          ...
          <div className="text-white-40 mb-8">
          ...
          <button
            onClick={onStart}
            className="bg-white-100 text-neutral-900 px-8 py-4 rounded-xl font-bold text-lg hover:bg-neutral-100 transition-all transform hover:scale-105"
          >
            Start Your Journey
          </button>
        </div>
